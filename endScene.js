...
export default class endtScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(400, 550, "Press ENTER to replay", {
        fontSize: "35px",
        fill: "#000",
      })
      .setOrigin(0.5, 0.5);
    ...
    this.add
      .text(400, 300, "Congrats, you WON!", { fontSize: "50px", fill: "#000" })
      .setOrigin(0.5, 0.5);

    this.add
      .text(400, 400, "Time: " + Math.round(gameState.gameRuntime * 10) / 10, {
        fontSize: "50px",
        fill: "#000",
      })
      .setOrigin(0.5, 0.5);
    ...
    this.add
      .text(400, 470, "Best Time: " + gameState.highScore, {
        fontSize: "50px",
        fill: "#000",
      })
      .setOrigin(0.5, 0.5);
